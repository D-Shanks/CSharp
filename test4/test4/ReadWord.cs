...
namespace test4
{
    class ReadWord
    {
        ...
        {
            string fileName = @"D:\Program Files\VS2017_workplace\test4\file_test4\原题.docx";
        ...
        {
            string fileName = @"D:\Program Files\VS2017_workplace\test4\file_test4\标准答案.docx";
        ...
        {
            string fileName = @"D:\Program Files\VS2017_workplace\test4\file_test4\students_answer\1002_李思思.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
        ...
        {
            string fileName = @"D:\Program Files\VS2017_workplace\test4\file_test4\students_answer\1003_王五.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
